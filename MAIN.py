lectname = "hist_L19" #Update me every time or i will append to this file. 
lectlen = '39:23'                           #Exact lecture length if asynchronous. 
speed =2.8                                  #This is your playback speed multiplier. 
path = 'THIS FOLDER CONTAINING THIS FILE'   #update me once. 
save_folder = 'UPDATE ME ONCE'              #update me once.
...
print(pos1)
print(pos2) #printed so you can check with windowspy and restart before lecture starts. 
regx2 = pos2[0]-pos1[0]
regy2 = pos2[1]-pos1[1]
ss_region = (pos1[0],pos1[1],regx2,regy2)


#These are the characters we want to track. (we dont want to track noise from handwriting)
